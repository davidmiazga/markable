...
export const formatKeymap: KeyBinding[] = [
  ...
  { key: "Alt-c", mac: "Alt-c", run: (v) => { insertCodeFence(v); return true; } },
  { key: "Alt-q", mac: "Alt-q", run: (v) => { toggleLinePrefix(v, "> "); return true; } },
  { key: "Alt-.", mac: "Alt-.", run: (v) => { toggleLinePrefix(v, "- "); return true; } },
  { key: "Alt-o", mac: "Alt-o", run: (v) => { toggleOrderedList(v); return true; } },
  { key: "Alt-x", mac: "Alt-x", run: (v) => { toggleTaskList(v); return true; } },
  { key: "Meta-]", mac: "Meta-]", run: (v) => { indentLines(v); return true; } },
  { key: "Meta-[", mac: "Meta-[", run: (v) => { outdentLines(v); return true; } },
  { key: "Alt-/", mac: "Alt-/", run: (v) => { insertHorizontalRule(v); return true; } },
