...
pub fn build_menu<R: Runtime>(handle: &AppHandle<R>) -> tauri::Result<Menu<R>> {
    ...
    let format_menu = Submenu::with_items(
        ...
        &[
            ...
            &MenuItem::with_id(handle, "format-bullet-list", "Bullet List", true, Some("CmdOrCtrl+Shift+L"))?,
            &MenuItem::with_id(handle, "format-ordered-list", "Ordered List", true, Some("CmdOrCtrl+Shift+O"))?,
            &MenuItem::with_id(handle, "format-task-list", "Task List", true, Some("CmdOrCtrl+Shift+T"))?,
            &PredefinedMenuItem::separator(handle)?,
